...
import alfabank.test.client.ExchangeClient;
...
public class ExchangeServiceImpl implements ExchangeService {
    ...
    private void refreshPrevRates(long time) {
        ...
        if (
            ...
            this.prevRates = exchangeClient.getHistoricalRates(newPrevDate, appId);
        }
    }
     ...
     * @param charCode
     */
    private Double getCoefficient(ExchangeModel rates, String charCode) {
        Double result = null;
