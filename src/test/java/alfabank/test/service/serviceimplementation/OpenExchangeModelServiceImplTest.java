package alfabank.test.service.serviceimplementation;

import alfabank.test.client.FeignExchangeClient;
...
public class OpenExchangeModelServiceImplTest {

    @Value("${exchange.base}")
    private String base;
    @Autowired
    private ExchangeServiceImpl exchangeRatesService;
    @MockBean
    private FeignExchangeClient openExchangeRatesClient;

    private ExchangeModel currentRates;
    private ExchangeModel prevRates;
    ...
    public void init() {
        int time = 1609459199;
        this.currentRates = new ExchangeModel();
        ...
        time = 1609372799;
        this.prevRates = new ExchangeModel();
